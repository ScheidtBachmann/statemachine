...
class TracingTreeExtensions {
     ...
     */
    private def Map<EObject, EObject> matchModels(EObject left, EObject right) {
        if (left === null || right === null) {
            return null;
        }
// chsch: deactivated because of dependency to 'org.eclipse.emf.compare'
//  (which is not available in form of proper maven packages)
