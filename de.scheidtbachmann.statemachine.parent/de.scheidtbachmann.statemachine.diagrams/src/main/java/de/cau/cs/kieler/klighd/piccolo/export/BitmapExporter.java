    ...
    private IStatus exportTile(final ExportData data, final KlighdCanvas canvas,
        ...
        try {
            ...
            final IStatus[] detailStatus = new IStatus[] {
                    new Status(IStatus.ERROR, Klighd.PLUGIN_ID, msg2, e)
            };
            ...
            return new MultiStatus(Klighd.PLUGIN_ID, 0, detailStatus, msg, null);
        }
        ...
        try {
            ...
            status = new Status(IStatus.ERROR, Klighd.PLUGIN_ID, msg, e);
            ...
            status = new Status(IStatus.ERROR, Klighd.PLUGIN_ID, t.getMessage(), t);
        }
